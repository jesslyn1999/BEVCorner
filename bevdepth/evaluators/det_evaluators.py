...
class DetNuscEvaluator():
    ...
    def __init__(
        ...
        data_root='./data/nuscenes_sample',
    ...
    def evaluate(
        ...
        result_files, tmp_dir = self.format_results(results, img_metas,
                                                    result_names,
                                                    jsonfile_prefix)
        if isinstance(result_files, dict):  # result_files is a dict  = {'img_bbox': './outputs/bevcorner/bev_depth_lss_r50_256x704_128x128_24e_2key_weighted_fusion_learned_mini/results_nusc.json'}
