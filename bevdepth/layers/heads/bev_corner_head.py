...
from .head import make_predictor, make_loss_evaluator, make_post_processor
# from .head import make_loss_evaluator, make_post_processor


__all__ = ['BEVCornerHead']
...
class BEVCornerHead(CenterHead):
    """Head for BevDepth.
    ...
    def __init__(
        ...
        super(BEVCornerHead, self).__init__(
    ...
    def forward(self, x):
        ...
        """
        # new_zeros(batch_size, num_channels, voxel_num[1], voxel_num[0])
        x = x.float()
        # FPN
        trunk_outs = [x]
    ...
    def get_targets_single(self, gt_bboxes_3d, gt_labels_3d):
        ...
        feature_map_size = grid_size[:2] // self.train_cfg['out_size_factor']  # 128
