...
class BEVDepthLightningModel(BaseBEVDepthLightningModel):
    ...
    def __init__(self, **kwargs):
        ...
        depth_refinement_cfgs = {
            'monoflex_depth_mode': kwargs['monoflex_depth_mode'],  # either ['fixed', 'gaussian']
            'depth_fused_mode': kwargs['depth_fused_mode'],  # either ['direct_replacement', 'weighted_fusion', 'roi_refinement', 'hard_combine']
            'depth_blend_weight_mode': kwargs['depth_blend_weight_mode'],  # either ['fixed', 'geometry', 'learned', '2d_loss']
        }
...
if __name__ == '__main__':
    run_cli(BEVDepthLightningModel,
            'pred_pure_bev_depth_lss_r50_256x704_128x128_24e_2key',
            run_mode='bevcorner',
            extra_trainer_config_args={'epochs': '16'})
