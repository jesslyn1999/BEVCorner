...
class Calibration(object):
    ...
    def __init__(self, intrin_mat):
        # Projection matrix from rect camera coord to image coord
        self.P = np.eye(4)
        self.P[:intrin_mat.shape[0], :intrin_mat.shape[1]] = intrin_mat
        self.P = np.reshape(self.P[:3, :4], [3, 4])
        ...
        self.c_u = intrin_mat[0, 2]
        self.c_v = intrin_mat[1, 2]
        self.f_u = intrin_mat[0, 0]
        self.f_v = intrin_mat[1, 1]
        self.b_x = 0
        self.b_y = 0
